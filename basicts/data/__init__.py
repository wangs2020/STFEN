...
from .dataset_zoo.simple_tsf_dataset import SpatialForecastingDataset
from .dataset_zoo.simple_tsf_dataset import SpatialTimeSeriesForecastingDataset
from .dataset_zoo.m4_dataset import M4ForecastingDataset

__all__ = ["SCALER_REGISTRY",  "M4ForecastingDataset"
           "TimeSeriesForecastingDataset", "SpatialForecastingDataset", "SpatialTimeSeriesForecastingDataset"]
