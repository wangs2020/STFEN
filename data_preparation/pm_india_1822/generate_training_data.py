...
if __name__ == "__main__":
    ...
    #IMG_DIR = "/data6/wangs/pm1/stfen/datasets/pm_india_1822/"
    IMG_DIR = "/data6/wangs/pm1/dataset_npy/pm_india_1822/"
    DATA_FILE_PATH = "/data6/wangs/pm1/stfen/datasets/raw_data/{0}/{0}.csv".format(DATASET_NAME)
    FEATURE_LT = [
    #'ALBEDO',
